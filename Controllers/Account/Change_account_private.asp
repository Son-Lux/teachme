<%
  Dim valore
    ...
    private_id = Request.Form("private_id")
    ...
    'With iMsg
       ...
       '.HTMLBody = "L'utente con ID '"&  private_id & "' ha cambiato l'url della sua pagina privata in: "&pageUrl
       '.Send
    'End With
