...
<div class="main">
	...
	recordset.Open query_di_interrogazione,connessione
        ...
        End If
                    recordset.close
                    query_di_interrogazione = "SELECT Class_Lessons.Name as Class_LessonsName, 'Corso di '+Class_Lessons.Name as descr, Class_Lessons.DateStart as Data, Class_Lessons.Price as Prezzo FROM ((Class_LessonsStudents 	INNER JOIN Student ON Student.StudentID = Class_LessonsStudents.StudentID) 	INNER JOIN Class_Lessons ON Class_LessonsStudents.Class_LessonsID = Class_Lessons.Class_LessonID) WHERE Class_LessonsStudents.StudentID = " & Session("student_id")
	                recordset.Open query_di_interrogazione,connessione
