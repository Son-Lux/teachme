...
<div class="main">
    ...
    query_di_interrogazione = "SELECT LessonID, Accepted, DateStartFormatted, DateEndFormatted, SchoolSubject.Name as SchoolSubjectName, Price * DateDiff ('n', DateStartFormatted, DateEndFormatted)/60 as StudentCreditToScale, private.Name as privateName, private.Surname as privateSurname FROM (Lessons INNER JOIN SchoolSubject ON Lessons.SchoolSubjectID = SchoolSubject.SchoolSubjectID) INNER JOIN private ON private.privateID = Lessons.privateID WHERE Lessons.privateID =" & Session("private_id") & " ORDER BY DateStartFormatted DESC"
        ...
        If Not recordset.EOF Then
            ...
            Accepted = recordset("Accepted")
                ...
                <tr>
                    ...
                    <td>Corso di <%=recordset("SchoolSubjectName") %> con <%=recordset("privateName") %>&nbsp;<%=recordset("privateSurname") %></td>
