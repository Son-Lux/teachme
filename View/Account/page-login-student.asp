            ...
            <div class="col-md-12 col-sm-12">
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="content-form-page">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <form class="form-horizontal form-without-legend" role="form" name="student_form" method="post" action="../../Controllers/Login/login_student.asp?returnurl=<%=request.QueryString("returnurl") %>">
                ...
                <div class="col-md-4 col-sm-4">
                    <form class="form-horizontal form_student" role="form" name="student_registration_form" method="post" action="../../Controllers/Register/register_student.asp">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label for="firstname" class="col-lg-4 control-label">Partita IVA</label>
                                <div class="col-lg-8">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label for="email" class="col-lg-4 control-label">Email <span class="require">*</span></label>
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" id="email_reg" name="email">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="password" class="col-lg-4 control-label">Password <span class="require">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-offset-4 padding-left-0 padding-top-20">
                                <input type="checkbox" value="false" id="privacy" name="privacy"/> Ho letto e accettato le <a href="/content/docs/contratto_utente.pdf">condizioni di utilizzo</a> del sito.<br /><br />
                ...
                <div class="col-md-4 col-sm-4">
                    <h1>Come funziona:</h1>
                    <ul>
                        <li>iscriviti gratuitamente attraverso il form</li>
                        <li>attraverso una ricerca filtrata scegli la lezione/corso che stai cercando</li>
                        <li>prenota direttamente la lezione/corso sull'agenda del Tutor</li>
                        <li>aspetta la conferma del Tutor</li>
                        <li>recati nel'orario scelto e all'indirizzo indicato dal Tutor </li>
                        <li>partecipa alla lezione/corso</li>
                        <li>paga direttamente al Tutor (secondo i metodi di pagamento da lui supportati)</li>
                        <li>lascia un feedback al Tutor</li>
                        <li>migliora le tue conoscenze!</li>
                    </ul>
                </div>
            </div>
