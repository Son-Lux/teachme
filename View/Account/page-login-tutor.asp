            ...
            <div class="col-md-12 col-sm-12">
                <div class="col-md-4 col-sm-4">
                    ...
                    <div class="content-form-page">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <form class="form-horizontal form-without-legend" role="form" name="tutor_form" method="post" action="../../Controllers/Login/login_tutor.asp">
                ...
                <div class="col-md-4 col-sm-4">
                    <form class="form-horizontal form_tutor" role="form" name="tutor_registration_form" method="post" action="../../Controllers/Register/register_tutor.asp">
                        <h1>Registra Tutor</h1>
                        <fieldset>
                        ...
                        <div class="row">
                            <div class="col-lg-8 padding-left-0 padding-top-20 col-md-offset-4">
                                <input type="checkbox" value="false" id="privacy" name="privacy"/> Ho letto e accettato le <a href="/content/docs/contratto_tutor.pdf">condizioni di utilizzo</a> del sito.<br /><br />
                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    <ul>
                        ...
                        <li>scegli il tipo di abbonamento che ti soddisfa</li>
                        <li>arricchisci la tua pagina personale con foto, sito web e tutti i recapiti utili</li>
                        <li>inserisci quali lezioni e/o corsi insegni</li>
                        <li>imposta la tua agenda elettronica in base ai tuoi impegni</li>
                        <li>ricevi la notifica quando un utente &egrave; interessato alla tua lezione o si &egrave; iscritto ad un tuo corso</li>
                        <li>conferma, rifiuta o proponi una modifica all'utente che ha prenotato</li>
                        <li>svolgi la lezione/corso negli orari concordati e nel luogo che hai scelto</li>
                        <li>ricevi il compenso direttamente dall'utente a fine lezione/corso attraverso i metodi di pagamento che hai indicato</li>
                        <li>aumenta il tuo guadagno !</li>
                    </ul>
                    <p>inoltre potrai:</p>
                    <ul>
                        <li>pubblicizzare la tua pagina personale</li>
                        <li>personalizzare l'url della tua pagina</li>
                        <li>rendere la tua pagina non visibile nelle ricerche</li>
                        <li>salvare la lezione prenotata in Google Cal, Apple Cal, ecc</li>
                        <li>controllare quanti posti sono ancora disponibili per tale corso </li>
                        <li>rivedere i dettagli degli utenti che hanno prenotato ( nome, cell, indirizzo) per ricordare o comunicare direttamente con loro</li>
                        <li>modificare costantemente l'agenda </li>
                        <li>controllare lo storico delle lezioni svolte</li>
                        <li>verificare il compenso dovuto da ogni utente</li>
                        <li>eliminare utenti dal corso che hanno avvisato di non poterci pi&ugrave; essere</li>
                        <li>modificare una lezione gi&agrave; confermata</li>
                    </ul>
                    ...
                    <p>Hai ancora delle perplessita? </p><a href="/Content/docs/faq tutor.pdf">Consulta le FAQ</a> 
                </div>
            </div>
            <div class="container">
                <div class="row margin-bottom-40">
                    <div class="col-md-12 col-sm-12">
                      ...
                      <span>Abbonamento
                                        ...
                                        <ul class="pricing-content list-unstyled">
                                            <li>
                                                <i class="fa fa-search"></i>Compari nelle ricerche
                                            </li>
                                            <li>
